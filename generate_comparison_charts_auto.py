...
AUTO_STOCK_COUNTS = [5, 10]
AUTO_PERIODS = ["1M", "3M", "6M", "YTD"]
...
def generate_all_charts():
    ...
    print()
    print("=" * 70)
    print("AUTOMATIC SECTOR RELATIVE PERFORMANCE")
    print("=" * 70)

    master = load_master()
    prices = load_prices()

    sectors = get_sectors(master)

    print()
    print(f"Sectors : {len(sectors)}")
    print("Periods : 1M, 3M, 6M, YTD")
    print("Stocks  : Top 5, Top 10")
    print()
    ...
    for sector in sectors:
        ...
        for period in AUTO_PERIODS:
            ...
            for stock_count in AUTO_STOCK_COUNTS:
    ...
    print()
    print("=" * 70)
    print("AUTOMATIC CHART GENERATION COMPLETE")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    try:
        raise SystemExit(generate_all_charts())
